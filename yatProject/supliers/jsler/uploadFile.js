...
function ekUpload() {
    ...
    function parseFile(file) {
        ...
        output(
            '<strong>' + encodeURI(file.name.substr(0, 15)) + '</strong>'
        );
...
function ekUpload1() {
    function Init() {
        ...
        var fileSelect = document.getElementById('file-upload1'),
            ...
            submitButton = document.getElementById('submit-button1');
    ...
    function uploadFile(file) {
        ...
        var xhr = new XMLHttpRequest(),
            fileInput = document.getElementById('class-roster-file1'),
...
function ekUpload4() {
    function Init() {
        ...
        var fileSelect = document.getElementById('file-upload4'),
            ...
            submitButton = document.getElementById('submit-button4');
    ...
    function uploadFile(file) {
        ...
        var xhr = new XMLHttpRequest(),
            fileInput = document.getElementById('class-roster-file4'),
...
function ekUpload5() {
    function Init() {
        ...
        var fileSelect = document.getElementById('file-upload5'),
            ...
            submitButton = document.getElementById('submit-button5');
    ...
    function uploadFile(file) {
        ...
        var xhr = new XMLHttpRequest(),
            fileInput = document.getElementById('class-roster-file5'),
