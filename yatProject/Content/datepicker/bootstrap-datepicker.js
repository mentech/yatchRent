! function (t) {
    ...
    d.prototype = {
        ...
        _resolveViewName: function (t, i) {
            return 0 === t || "days" === t || "month" === t ? 0 : 1 === t || "months" === t || "year" === t ? 1 : 2 === t || "years" === t || "decade" === t ? 2 : 3 === t || "decades" === t || "century" === t ? 3 : 4 === t || "centuries" === t || "millennium" === t ? 4 : i === e ? !1 : i
        },
        ...
        _process_options: function (e) {
            ...
            if (s.startDate !== -(1 / 0) && (s.startDate = s.startDate ? s.startDate instanceof Date ? this._local_to_utc(this._zero_time(s.startDate)) : D.parseDate(s.startDate, o, s.language, s.assumeNearbyYear) : -(1 / 0)), s.endDate !== 1 / 0 && (s.endDate = s.endDate ? s.endDate instanceof Date ? this._local_to_utc(this._zero_time(s.endDate)) : D.parseDate(s.endDate, o, s.language, s.assumeNearbyYear) : 1 / 0), s.daysOfWeekDisabled = s.daysOfWeekDisabled || [], t.isArray(s.daysOfWeekDisabled) || (s.daysOfWeekDisabled = s.daysOfWeekDisabled.split(/[,\s]*/)), s.daysOfWeekDisabled = t.map(s.daysOfWeekDisabled, function (t) {
                ...
                var r = [];
                r.push(D.parseDate(s.datesDisabled, o, s.language, s.assumeNearbyYear)), s.datesDisabled = r
            }
        ...
        update: function () {
            ...
            }, this), !0), this.dates.replace(i), this.viewDate = this.dates.length ? new Date(this.dates.get(-1)) : this.viewDate < this.o.startDate ? new Date(this.o.startDate) : this.viewDate > this.o.endDate ? new Date(this.o.endDate) : this.o.defaultViewDate, a ? this.setValue() : i.length && String(e) !== String(this.dates) && this._trigger("changeDate"), !this.dates.length && e.length && this._trigger("clearDate"), this.fill(), this.element.change(), this
        },
        fillDow: function () {
        ...
        fillMonths: function () {
            for (var t = this._utc_to_local(this.viewDate), e = "", i = 0; 12 > i;) {
                ...
                e += '<span class="month' + a + '">' + m[this.o.language].monthsShort[i++] + "</span>"
            }
        ...
        _fill_yearsView: function (i, a, s, n, o, r, h, l) {
            var d, u, c, p, f, g, m, D, v, y, w;
            for (d = "", u = this.picker.find(i), c = parseInt(o / s, 10) * s, f = parseInt(r / n, 10) * n, g = parseInt(h / n, 10) * n, p = t.map(this.dates, function (t) {
                return parseInt(t.getUTCFullYear() / n, 10) * n
            }), u.find(".datepicker-switch").text(c + "-" + (c + 9 * n)), m = c - n, D = -1; 11 > D; D += 1) v = [a], y = null, -1 === D ? v.push("old") : 10 === D && v.push("new"), -1 !== t.inArray(m, p) && v.push("active"), (f > m || m > g) && v.push("disabled"), m === this.viewDate.getFullYear() && v.push("focused"), l !== t.noop && (w = l(new Date(m, 0, 1)), w === e ? w = {} : "boolean" == typeof w ? w = {
                enabled: w
            } : "string" == typeof w && (w = {
                classes: w
            }), w.enabled === !1 && v.push("disabled"), w.classes && (v = v.concat(w.classes.split(/\s+/))), w.tooltip && (y = w.tooltip)), d += '<span class="' + v.join(" ") + '"' + (y ? ' title="' + y + '"' : "") + ">" + m + "</span>", m += n;
            u.find("td").html(d)
        },
        fill: function () {
            ...
            if (!isNaN(o) && !isNaN(r)) {
                this.picker.find(".datepicker-days .datepicker-switch").text(D.formatDate(n, f, this.o.language)), this.picker.find("tfoot .today").text(c).toggle(this.o.todayBtn !== !1), this.picker.find("tfoot .clear").text(p).toggle(this.o.clearBtn !== !1), this.picker.find("thead .datepicker-title").text(this.o.title).toggle("" !== this.o.title), this.updateNavArrows(), this.fillMonths();
                var g = i(o, r - 1, 28),
                    v = D.getDaysInMonth(g.getUTCFullYear(), g.getUTCMonth());
                g.setUTCDate(v), g.setUTCDate(v - (g.getUTCDay() - this.o.weekStart + 7) % 7);
                var y = new Date(g);
                g.getUTCFullYear() < 100 && y.setUTCFullYear(g.getUTCFullYear()), y.setUTCDate(y.getUTCDate() + 42), y = y.valueOf();
                for (var w, k = []; g.valueOf() < y;) {
                    if (g.getUTCDay() === this.o.weekStart && (k.push("<tr>"), this.o.calendarWeeks)) {
                        var C = new Date(+g + (this.o.weekStart - g.getUTCDay() - 7) % 7 * 864e5),
                            b = new Date(Number(C) + (11 - C.getUTCDay()) % 7 * 864e5),
                            _ = new Date(Number(_ = i(b.getUTCFullYear(), 0, 1)) + (11 - _.getUTCDay()) % 7 * 864e5),
                            T = (b - _) / 864e5 / 7 + 1;
                        k.push('<td class="cw">' + T + "</td>")
                    }
                    w = this.getClassNames(g), w.push("day"), this.o.beforeShowDay !== t.noop && (s = this.o.beforeShowDay(this._utc_to_local(g)), s === e ? s = {} : "boolean" == typeof s ? s = {
                        enabled: s
                    } : "string" == typeof s && (s = {
                        classes: s
                    }), s.enabled === !1 && w.push("disabled"), s.classes && (w = w.concat(s.classes.split(/\s+/))), s.tooltip && (a = s.tooltip)), w = t.unique(w), k.push('<td class="' + w.join(" ") + '"' + (a ? ' title="' + a + '"' : "") + ">" + g.getUTCDate() + "</td>"), a = null, g.getUTCDay() === this.o.weekEnd && k.push("</tr>"), g.setUTCDate(g.getUTCDate() + 1)
                }
                this.picker.find(".datepicker-days tbody").empty().append(k.join(""));
                var M = m[this.o.language].monthsTitle || m.en.monthsTitle || "Months",
                ...
                if (t.each(this.dates, function (t, e) {
                ...
                }), (h > o || o > d) && U.addClass("disabled"), o === h && U.slice(0, l).addClass("disabled"), o === d && U.slice(u + 1).addClass("disabled"), this.o.beforeShowMonth !== t.noop) {
                    var x = this;
                    t.each(U, function (i, a) {
                        ...
                        n === e ? n = {} : "boolean" == typeof n ? n = {
                            ...
                            classes: n
                        }), n.enabled !== !1 || t(a).hasClass("disabled") || t(a).addClass("disabled"), n.classes && t(a).addClass(n.classes), n.tooltip && t(a).prop("title", n.tooltip)
                    })
                }
        ...
        moveMonth: function (t, e) {
            ...
            }, i = r + e, s.setUTCMonth(i), (0 > i || i > 11) && (i = (i + 12) % 12);
            else {
        ...
        showMode: function (t) {
            t && (this.viewMode = Math.max(this.o.minViewMode, Math.min(this.o.maxViewMode, this.viewMode + t))), this.picker.children("div").hide().filter(".datepicker-" + D.modes[this.viewMode].clsName).show(), this.updateNavArrows()
        }
    };
    var u = function (e, i) {
        ...
        p = function (i) {
            ...
            if (this.each(function () {
                ...
                if (!n) {
                    ...
                    }), n = new u(this, g)) : n = new d(this, g), e.data("datepicker", n)
                }
    ...
    var m = t.fn.datepicker.dates = {
        ...
        D = {
            ...
            parseDate: function (s, n, o, r) {
                ...
                if ("string" == typeof n && (n = D.parseFormat(n)), n.toValue) return n.toValue(s, n, o);
                var u, c, p, f, g = /([\-+]\d+)([dmwy])/,
                    v = s.match(/([\-+]\d+)([dmwy])/g),
                    y = {
                        d: "moveDay",
                        m: "moveMonth",
                ...
                if (/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(s)) {
                    for (s = new Date, p = 0; p < v.length; p++) u = g.exec(v[p]), c = parseInt(u[1]), f = y[u[2]], s = d.prototype[f](s, c);
                    return i(s.getUTCFullYear(), s.getUTCMonth(), s.getUTCDate())
                }
                if ("undefined" != typeof w[s] && (s = w[s], v = s.match(/([\-+]\d+)([dmwy])/g), /^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(s))) {
                    for (s = new Date, p = 0; p < v.length; p++) u = g.exec(v[p]), c = parseInt(u[1]), f = y[u[2]], s = d.prototype[f](s, c);
                    return i(s.getUTCFullYear(), s.getUTCMonth(), s.getUTCDate())
                }
                ...
                var k, C, b = {},
                    ...
                    T = {
                        yyyy: function (t, e) {
                            return t.setUTCFullYear(r ? h(e, r) : e)
                        },
                        yy: function (t, e) {
                            return t.setUTCFullYear(r ? h(e, r) : e)
                        },
                ...
                if (v.length !== M.length && (M = t(M).filter(function (e, i) {
                    ...
                    var U;
                    for (p = 0, U = M.length; U > p; p++) {
                        if (k = parseInt(v[p], 10), u = M[p], isNaN(k)) switch (u) {
                            case "MM":
                                C = t(m[o].months).filter(l), k = t.inArray(C[0], m[o].months) + 1;
                                break;
                            case "M":
                                C = t(m[o].monthsShort).filter(l), k = t.inArray(C[0], m[o].monthsShort) + 1
                        }
                        b[u] = k
                    }
                    var x, F;
                    for (p = 0; p < _.length; p++) F = _[p], F in b && !isNaN(b[F]) && (x = new Date(s), T[F](x, b[F]), isNaN(x) || (s = x))
                }
                return s
            },
    ...
    D.template = '<div class="datepicker"><div class="datepicker-days"><table class=" table-condensed">' + D.headTemplate + "<tbody></tbody>" + D.footTemplate + '</table></div><div class="datepicker-months"><table class="table-condensed">' + D.headTemplate + D.contTemplate + D.footTemplate + '</table></div><div class="datepicker-years"><table class="table-condensed">' + D.headTemplate + D.contTemplate + D.footTemplate + '</table></div><div class="datepicker-decades"><table class="table-condensed">' + D.headTemplate + D.contTemplate + D.footTemplate + '</table></div><div class="datepicker-centuries"><table class="table-condensed">' + D.headTemplate + D.contTemplate + D.footTemplate + "</table></div></div>", t.fn.datepicker.DPGlobal = D, t.fn.datepicker.noConflict = function () {
        return t.fn.datepicker = c, this
    }, t.fn.datepicker.version = "1.7.0-dev", t(document).on("focus.datepicker.data-api click.datepicker.data-api", '[data-provide="datepicker"]', function (e) {
        var i = t(this);
